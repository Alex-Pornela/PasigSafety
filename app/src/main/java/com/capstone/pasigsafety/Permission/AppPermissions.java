...
import com.capstone.pasigsafety.Constant.AllConstant;


public class AppPermissions {


    public void startPermissionRequest(FragmentActivity fr, PermissionInterface fs, String manifest){
