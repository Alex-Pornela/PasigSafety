package com.capstone.pasigsafety;

import com.capstone.pasigsafety.Model.GeometryModel;
import com.capstone.pasigsafety.Model.PhotoModel;
...
/*
    ...
    @Expose
    private GeometryModel geometry;     //return the location of place

    @SerializedName("icon")
    @Expose
    private String icon;       //icon of place
    ...
    @Expose
    private List<PhotoModel> photos = null;     //photo of the place

    @SerializedName("place_id")
    @Expose
    private String placeId;     //place id by google that will remain same for every places
    ...
    @Expose
    private List<String> types = null;      //place types which is police station
